...
> yet.** This repository will hold releases only; watch it if you want to
...
always know where to look. You are in **mad-max-vr-mod**.

| Repository | What lives here |
| --- | --- |
| **mad-max-vr-mod** ← you are here | The mod itself — currently empty; groundwork phase. |
